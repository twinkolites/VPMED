...
const MaintenancePDF: React.FC<MaintenancePDFProps> = ({ service }) => {
  const reportNumber = service.quotation_number || `PM-${service.id.slice(-6).toUpperCase()}`
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ marginBottom: 25 }}>
          ...
          <Text style={styles.descriptionParagraph}>
            {service.description || 'No specific maintenance details provided.'}
          </Text>
        </View>
        ...
        {service.parts_used && service.parts_used.length > 0 && (
          <View style={styles.partsTableContainer}>
            <Text style={styles.sectionTitle}>Parts/Materials Used for Maintenance</Text>
        ...
        {/* Thank you */}
        <Text style={styles.thankYou}>--- END OF MAINTENANCE REPORT ---</Text>
      </Page>
    </Document>
  )
}
